...
var x__25663__auto__ = (((x == null))?null:x);
var m__25664__auto__ = (sablono.util.to_str[goog.typeOf(x__25663__auto__)]);
if(!((m__25664__auto__ == null))){
return m__25664__auto__.call(null,x);
} else {
var m__25664__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25664__auto____$1 == null))){
return m__25664__auto____$1.call(null,x);
} else {
...
var x__25663__auto__ = (((x == null))?null:x);
var m__25664__auto__ = (sablono.util.to_uri[goog.typeOf(x__25663__auto__)]);
if(!((m__25664__auto__ == null))){
return m__25664__auto__.call(null,x);
} else {
var m__25664__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25664__auto____$1 == null))){
return m__25664__auto____$1.call(null,x);
} else {
...
var len__26066__auto___27473 = arguments.length;
var i__26067__auto___27474 = (0);
while(true){
if((i__26067__auto___27474 < len__26066__auto___27473)){
args__26073__auto__.push((arguments[i__26067__auto___27474]));

var G__27475 = (i__26067__auto___27474 + (1));
i__26067__auto___27474 = G__27475;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__26074__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27472){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27472));
});
/**
...
var vec__27477 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__27477,(0),null);
var words = cljs.core.nthnext.call(null,vec__27477,(1));
...
var G__27479 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__27479,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__27479;
}
} else {
...
var args__26073__auto__ = [];
var len__26066__auto___27482 = arguments.length;
var i__26067__auto___27483 = (0);
while(true){
if((i__26067__auto___27483 < len__26066__auto___27482)){
args__26073__auto__.push((arguments[i__26067__auto___27483]));

var G__27484 = (i__26067__auto___27483 + (1));
i__26067__auto___27483 = G__27484;
continue;
} else {
}
break;
...
var argseq__26074__auto__ = ((((0) < args__26073__auto__.length))?(new cljs.core.IndexedSeq(args__26073__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__26074__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__27480_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__27480_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__27480_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__27480_SHARP_)){
return p1__27480_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__27480_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq27481){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27481));
});
/**
...
var vec__27488 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__27488,(0),null);
var names = cljs.core.nth.call(null,vec__27488,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__27488,tag_name,names){
return (function (p1__27485_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__27485_SHARP_));
});})(matches,vec__27488,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__27488,tag_name,names){
return (function (p1__27486_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__27486_SHARP_));
});})(matches,vec__27488,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__27489){
var vec__27492 = p__27489;
var tag = cljs.core.nth.call(null,vec__27492,(0),null);
var content = cljs.core.nthnext.call(null,vec__27492,(1));
...
var vec__27493 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__27493,(0),null);
var id = cljs.core.nth.call(null,vec__27493,(1),null);
var class$ = cljs.core.nth.call(null,vec__27493,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__25008__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1525285172555